      ...
      <div className="max-w-4xl mx-auto p-3">
        ...
        <div>
          ...
          <p className="text-lg text-gray-700 leading-relaxed mt-4">
            At Hơ Lơ Beauty, we believe in personalized care, a welcoming environment, and the transformative power of beauty. Every service we offer is designed with our clients' needs in mind, whether it's a rejuvenating facial, a stunning makeup application, or a complete beauty makeover. Our goal is to make you feel your best—every day.
          </p>
        </div>
      </div>
    </>
